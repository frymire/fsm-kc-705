...
proc create_root_design { parentCell } {
  ...
  set button_west [ create_bd_port -dir I -type data button_west ]
  ...
  connect_bd_net -net button_center_1 [get_bd_ports button_center] [get_bd_pins button_concat/In0]
  connect_bd_net -net button_concat_dout [get_bd_pins button_concat/dout] [get_bd_pins cheat_code/buttons_NSEWC]
  ...
  connect_bd_net -net button_south_1 [get_bd_ports button_south] [get_bd_pins button_concat/In3]
  connect_bd_net -net button_west_1 [get_bd_ports button_west] [get_bd_pins button_concat/In1]
  connect_bd_net -net cheat_code_leds [get_bd_ports leds] [get_bd_pins cheat_code/leds]
  connect_bd_net -net clk_wiz_clk_100 [get_bd_pins cheat_code/clk] [get_bd_pins clk_wiz/clk_100]
  connect_bd_net -net clk_wiz_locked [get_bd_pins cheat_code/reset_n] [get_bd_pins clk_wiz/locked]
